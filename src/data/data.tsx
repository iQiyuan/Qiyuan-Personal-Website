...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Implemented motion planning for the UR5 robotic arm using MoveIt with TrajOpt for global trajectory and Cartesian Path for precise end-effector motion. 
        Resulted in improved execution efficiency, and reduced mechanical wear in industrial automation tasks. 
        Deployed a vision-based pushing and grasping system on the UR5 robotic arm, training a self-supervised deep reinforcement learning model (VPG) to enhance object manipulation efficiency, 
        resulting in improved grasp success rates in cluttered environments.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Deployed LiDAR SLAM-based indoor navigation, with LIO-SAM for LiDAR-IMU fusion. Integrating A* + DWA for real-time navigation and obstacle avoidance. 
        Accelerated the iScan2BIM workflow by one-third and enabled more efficient indoor navigation. Designed and 3D printed low-friction TPU wheels and flexible chassis components, 
        optimizing tread patterns, wheel geometry, and structural damping to reduce vibration and improve stability in differential drive ground vehicles.
      </p>
    ),
  },
];
